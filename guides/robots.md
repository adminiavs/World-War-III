...
- **Robots** in the literal sense (uncrewed ground or maritime systems) appear mainly in **mine-clearing**: the US is “relying on robots” and helicopters because traditional minesweepers were retired. So **robots are in use for a specific mission**, not yet as the main combatant.
